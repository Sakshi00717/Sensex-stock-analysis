# Sensex-stock-analysis
# Created a comprehensive list of the top 30 Indian stocks with their financial fundamentals, Enabled analysis of specific stock fundamentals, sector-based stock retrieval, and comparative evaluation of  multiple stocks based on various fundamental values. 
# include<stdio.h>
#include<string.h>
